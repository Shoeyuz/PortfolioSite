...
<html lang = "eg">
    <head>
        ...
        <link rel="stylesheet" href="/PortfolioSite/css/workExperience.css">
    ...
    <nav class="nav nav-pills nav-fill navbar navbar-light" style="background-color: #e3f2fd;">
        ...
        <a class="nav-item nav-link active" href="/PortfolioSite/html/workExperience.php">Work Experience</a>
